...
SELECT
  ...
  CASE
	...
	CASE
		...
		WHEN (Age_At_Start_of_Spell_SUS < 18 OR Age_At_Start_of_Spell_SUS >= 7000) AND Admission_Method LIKE '2%' THEN 'paeds-emer'
		WHEN (Age_At_Start_of_Spell_SUS < 18 OR Age_At_Start_of_Spell_SUS >= 7000) AND Admission_Method IN ('11', '12', '13') AND Patient_Classification = '1' THEN 'paeds-elec'
