...
get_lookup_proj <- function(filenm_out) {
  dplyr::tribble(
    ...
    "snpp", "var_proj_10_year_migration", "10 year internal migration trend", "ppp", "ppp", 
    "snpp", "var_proj_alt_internal_migration", "5 year internal migration trend", "ppp", "ppp", 
    ...
    "npp", "cnp", "Constant fertility no mortality improvement", "ppp", NA_character_, 
    ...
    "npp", "ppq", "0% Future EU migration (Not National Statistics)", "ppp", NA_character_, 
    "npp", "ppr", "50% Future EU migration (Not National Statistics)", "ppp", NA_character_, 
...
get_lookup_lad18_lad23 <- function(filenm_out) {
  dplyr::tribble(
    ...
    2019, "E06000029", "Poole", "E06000058", "Bournemouth, Christchurch and Poole", 
    ...
    2023, "E07000027", "Barrow-in-Furness", "E06000064", "Westmorland and Furness", 
    ...
    2019, "E07000048", "Christchurch", "E06000058", "Bournemouth, Christchurch and Poole", 
    ...
    2021, "E07000152", "East Northamptonshire", "E06000061", "North Northamptonshire", 
    2021, "E07000153", "Kettering", "E06000061", "North Northamptonshire",
    2021, "E07000154", "Northampton", "E06000062", "West Northamptonshire",
    2021, "E07000155", "South Northamptonshire", "E06000062", "West Northamptonshire", 
    ...
    # 2019, "E07000190", "Taunton Deane", "E07000246", "Somerset West and Taunton", 
    # 2019, "E07000191", "West Somerset", "E07000246", "Somerset West and Taunton", 
